/**
 * Contagens ao longo do eixo das longarinas (pure).
 * Túnel em contagem inteira própria; meio módulo apenas no campo dedicado.
 */

import type { ModuleSegment, ModuleSpanCounts } from '../domain/pdfV2/types';
...
/** Equiv. longitudinal (meio = ½, túnel = 1) — ordenação / coerência interna, não texto comercial. */
